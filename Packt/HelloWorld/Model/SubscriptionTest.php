...
class SubscriptionTest extends PHPUnit_Framework_TestCase {
    ...
    public function setUp() {
        ...
        Mage::app('default');
        $this->_subscriptionInstance = Mage::
                getModel('helloworld/subscription');
    }
    ...
    public function testGetAllSubscriptions() {
        ...
        $this->assertInstanceOf('Packt_Helloworld_Model_ Resource_Subscription_Collection', $subscriptions);
    }
