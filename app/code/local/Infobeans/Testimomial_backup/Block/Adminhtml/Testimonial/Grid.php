...
class Infobeans_Testimonial_Block_Adminhtml_Testimonial_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
		...
		protected function _prepareColumns()
		{
				...
				'index' => 'status',
				'type' => 'options',
				'options'=>Infobeans_Testimonial_Block_Adminhtml_Testimonial_Grid::getOptionArray8(),				
				));
		...
		{
            $data_array=array();
			foreach(Infobeans_Testimonial_Block_Adminhtml_Testimonial_Grid::getOptionArray6() as $k=>$v){
		...
		{
            $data_array=array();
			foreach(Infobeans_Testimonial_Block_Adminhtml_Testimonial_Grid::getOptionArray8() as $k=>$v){
               $data_array[]=array('value'=>$k,'label'=>$v);		
			}
            return($data_array);
